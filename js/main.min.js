...
/* harmony import */ var _modules_baguettebox_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/baguettebox.js */ "./js/modules/baguettebox.js");
/* harmony import */ var _modules_baguettebox_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_baguettebox_js__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/scroll */ "./js/modules/scroll.js");
/* harmony import */ var _modules_wow__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/wow */ "./js/modules/wow.js");
/* harmony import */ var _modules_wow__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_modules_wow__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/tabs */ "./js/modules/tabs.js");
/* harmony import */ var _modules_accordion__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/accordion */ "./js/modules/accordion.js");
      ...
      window.addEventListener('DOMContentLoaded', function () {
        // Modules
        Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_8__["initScroll"])();
        ...
        Object(_modules_intro_slider__WEBPACK_IMPORTED_MODULE_7__["initIntroSlider"])();
        Object(_modules_slider__WEBPACK_IMPORTED_MODULE_3__["initSlider"])();
        Object(_modules_mask__WEBPACK_IMPORTED_MODULE_4__["initMask"])();
        Object(_modules_validation__WEBPACK_IMPORTED_MODULE_5__["initValidation"])();
        Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_10__["initTabs"])();
        Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_11__["initAccordions"])();
        _modules_baguettebox_js__WEBPACK_IMPORTED_MODULE_6___default.a.run('.gallery__wrapper');
        new _modules_wow__WEBPACK_IMPORTED_MODULE_9___default.a().init();
      });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAccordions", function () { return initAccordions; });
      var initAccordions = function initAccordions() {
        //accordions
        var accordions = document.querySelectorAll("._tabs-accordion");
        accordions.forEach(function (el) {
          var button = el.querySelector('._tabs-button');
          var content = el.querySelector('._tabs-content');
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initScrollToTop", function () { return initScrollToTop; });
      var initScrollToTop = function initScrollToTop() {
        var goTopBtn = document.querySelector(".scroll-top");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTabs", function () { return initTabs; });
      var initTabs = function initTabs() {
        //Tabs
        var tabButtons = document.querySelectorAll("._tabs-item");
        var tabs_blocks = document.querySelectorAll("._tabs-block");
        tabButtons.forEach(function (button) {
          button.addEventListener('click', function (evt) {
            evt.preventDefault();
            var targetBtn = evt.currentTarget;
            var targetBtnId = targetBtn.getAttribute('data-tab');
            var currentTab = document.querySelector(targetBtnId);
            if (!targetBtn.classList.contains('_active')) {
              tabButtons.forEach(function (button) {
                button.classList.remove('_active');
              });
              tabs_blocks.forEach(function (button) {
                button.classList.remove('_active');
              });
...
console.log("подключен main.min.js");